...
import metrics
from ConvAE_MaxPool import CAE_MaxPool
...
class DCEC(object):
    def __init__(self,
        ...
        self.cae = CAE_MaxPool(input_shape, filters)
    ...
    def pretrain(self, x, batch_size=256, epochs=200, optimizer='adam', save_dir='results/temp'):
        ...
        self.cae.save(save_dir + '/pretrain_cae_model_mnist_max_pool.h5')
        print('Pretrained weights are saved to %s/pretrain_cae_model_mnist_max_pool.h5' % save_dir)
    ...
    def fit(self, x, y=None, batch_size=256, maxiter=2e4, tol=1e-3,
        ...
        for ite in range(int(maxiter)):
            ...
            if ite % save_interval == 0:
                ...
                print('saving model to:', save_dir + '/dcec_model_max_pool' + str(ite) + '.h5')
                self.model.save_weights(save_dir + '/dcec_model_max_pool' + str(ite) + '.h5')

            ite += 1

        # save the trained model
        logfile.close()
        print('saving model to:', save_dir + '/pretrain_cae_model_mnist_max_pool.h5')
        self.model.save_weights(save_dir + '/pretrain_cae_model_mnist_max_pool.h5')
        t3 = time()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--cae_weights', default="results/temp/pretrain_cae_model_mnist_max_pool.h5", help='This argument must be given')
